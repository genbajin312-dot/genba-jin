...
import { Building, Hammer, TreeDeciduous } from "lucide-react";
  ...
  return (
    <section ref={containerRef} className="relative h-[70vh] md:h-[80vh] w-full overflow-hidden bg-[#0f172a]">
      ...
      <Parallax offset={150}>
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1636790921342-cbdc4b783de6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb25zdHJ1Y3Rpb24lMjBzaXRlJTIwd29ya2Vyc3xlbnwxfHx8fDE3NjYxMDIwNTl8MA&ixlib=rb-4.1.0&q=80&w=1080"
            alt="事業内容"
      ...
      >
        ...
        >
          土木工事、建築工事、外構工事を通じて、<br className="hidden md:block" />
          確かな技術で街づくりを支えます。
        </motion.p>
      </motion.div>
